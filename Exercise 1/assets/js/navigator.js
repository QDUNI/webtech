{
    ...
    const navEdit = document.createElement("nav");
    navEdit.setAttribute("class", "nav__edit");
    const navEdit_a = document.createElement("a");
    navEdit_a.setAttribute("href", "javascript:void(0);");
    navEdit_a.setAttribute("class", "icon");
    navEdit_a.setAttribute("onClick", "OpenEditor()");
    navEdit.appendChild(navEdit_a);


    const navEdit_img = document.createElement("img");
    navEdit_img.setAttribute("alt", "edit icon");
    navEdit_img.setAttribute("src", "assets/img/edit.png");
    navEdit_a.appendChild(navEdit_img);
    ...
    navWrapper.appendChild(navEdit);
